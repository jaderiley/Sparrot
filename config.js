...
const CONFIG = {
  ...
  business: {
    ...
    phone:     "",
    whatsapp:  "",
    address:   "173 Oxford Rd, Johannesburg, South Africa",
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "Sparrot — Solar installation in johannesburg",
    description: "Sparrot provides professional solar installation in Johannesburg. 6 Google reviews. Call for a quote today.",
  ...
  content: {
    ...
    heroLead:   "Sparrot designs and installs solar panel systems, battery backup and inverter solutions for homes and businesses across Johannesburg. Load-shedding proof your property.",
    ...
    band: {
      ...
      alt:   "Sparrot team at work in Johannesburg",
